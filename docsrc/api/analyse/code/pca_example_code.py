...
lowc_hindiii_100k = bloom.load("architecture/other-hic/lowc_hindiii_100k_1mb.hic")
lowc_hindiii_5M = bloom.load("architecture/other-hic/lowc_hindiii_5M_1mb.hic")
lowc_mboi_1M = bloom.load("architecture/other-hic/lowc_mboi_1M_1mb.hic")
lowc_mboi_100k = bloom.load("architecture/other-hic/lowc_mboi_100k_1mb.hic")
lowc_mboi_50k = bloom.load("architecture/other-hic/lowc_mboi_50k_1mb.hic")
...
fig, ax = bloomplot.pca_plot(pca_result, variance=pca_info,
