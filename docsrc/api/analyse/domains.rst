...
example ``bloom auto`` command in  :ref:`example-bloom-auto` to generate all the
...
Also have a look at the command line documentation at :ref:`bloom-domains`, which explains
...
Insulation scores are calculated and saved to disk using the :class:`~bloom.architecture.domains.InsulationScores`
class. To run a basic insulation score calculation on a Hi-C object, use
:class:`~bloom.architecture.domains.InsulationScores.from_hic`:
...
The file created in ``file_name`` can later be easily loaded with :func:`~bloom.load`.

The resulting object stores all insulation score tracks for the ``window_sizes``
provided. It is derived from the :class:`~bloom.regions.RegionsTable` class, which is
...
:func:`~bloom.architecture.domains.InsulationScores.scores` function, which requires
...
:func:`~bloom.architecture.domains.InsulationScores.score_regions`. The score is then
...
:class:`~bloom.architecture.domains.InsulationScores.from_hic` has several parameters that
...
:func:`~bloom.architecture.domains.InsulationScores.to_bed`, or
:func:`~bloom.architecture.domains.InsulationScores.to_gff`. Export to a fast BigWig track using
:func:`~bloom.architecture.domains.InsulationScores.to_bigwig`.
...
You can plot all calculated insulation scores using :class:`~bloom.plotting.GenomicVectorArrayPlot`:
...
If you only want to plot a single score track, use :class:`~bloom.plotting.LinePlot`:
...
using :class:`~bloom.architecture.domains.Boundaries`, specifically
:func:`~bloom.architecture.domains.Boundaries.from_insulation_score`:
...
as a :class:`~bloom.regions.RegionsTable` object, which is :ref:`genomic_regions`. The
...
The dedicated class :class:`~bloom.architecture.domains.DirectionalityIndexes` handles all
relevant actions. Use :func:`~bloom.architecture.domains.DirectionalityIndexes.from_hic` to
