...
# start snippet check
hic = bloom.load("examples/output/hic/binned/bloom_example_500kb.hic")
isinstance(hic, bloom.matrix.RegionPairsContainer)  # True if interface supported
# end snippet check

# start snippet create
# create a few regions
region1 = bloom.GenomicRegion(chromosome='chr1', start=1, end=1000, ix=0)
region2 = bloom.GenomicRegion(chromosome='chr1', start=1001, end=2000, ix=1)
region3 = bloom.GenomicRegion(chromosome='chr2', start=1, end=1000, ix=2)

# connect regions with edges
edge1 = bloom.Edge(region1, region2, weight=10)
edge2 = bloom.Edge(region1, region3, weight=1, foo='test')
edge3 = bloom.Edge(region2, region3, weight=2, bar=[1, 2, 3, 4])
# end snippet create
...
edge_ix = bloom.Edge(0, 1, weight=0.2)
...
edge_counter = 0
region = bloom.GenomicRegion(chromosome='chr19', start=6000000, end=18000000)
