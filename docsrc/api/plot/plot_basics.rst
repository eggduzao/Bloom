...
bloom plotting functions are imported in a Python script or console using

.. literalinclude:: code/matrix_plot_examples.py
    :language: python
    :start-after: start snippet bloomplot import
    :end-before: end snippet bloomplot import

This will provide access to the bloom plot types and custom colormaps for matrix visualisation.

For the following sections we will load a :class:`~bloom.hic.Hic` file for plotting:

.. literalinclude:: code/matrix_plot_examples.py
    :language: python
    :start-after: start snippet bloomplot load hic
    :end-before: end snippet bloomplot load hic
...
Each plot type is based on the :class:`~bloom.plotting.base_plotter.BasePlotter` class.
It controls the formatting of the X axis in genomic coordinates (kb, mb, etc), and provides
a :func:`~bloom.plotting.base_plotter.BasePlotter.plot` function, common to all bloom plot types,
...
As an example of basic functionality, we will be looking at the :class:`~bloom.plotting.TriangularMatrixPlot`:
...
.. literalinclude:: code/matrix_plot_examples.py
    :language: python
    :start-after: start snippet bloomplot matplotlib
    :end-before: end snippet bloomplot matplotlib

And use the ``ax`` argument of the bloom plot to supply it with a custom axis.

.. literalinclude:: code/matrix_plot_examples.py
    :language: python
    :start-after: start snippet bloomplot plt axes
    :end-before: end snippet bloomplot plt axes
