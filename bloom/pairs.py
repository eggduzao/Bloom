...
class FragmentRead(object):
    ...
    .. attribute:: fragment
        ...
        A :class:`~bloom.GenomicRegion` delineated by
        restriction sites.
    ...
    def __init__(self, fragment=None, position=None, strand=0):
        ...
        :param fragment: A :class:`~bloom.GenomicRegion` delineated by
                         restriction sites.
...
class LazyFragment(GenomicRegion):
    """
    :class:`~bloom.GenomicRegion` representing a fragment with lazy attribute loading.
...
class ReadPairs(RegionPairsTable):
    ...
    This class is a :class:`~bloom.RegionBased` object, where each
    :class:`~bloom.GenomicRegion` represents a restriction fragment
    from a Hi-C experiment. A list of fragments can be obtained with
    the :func:`~bloom.regions.genome_regions` function, for example.
    ...
    .. code::
        ...
        re_fragments = bloom.genome_regions("hg19_chr18_19.fa", "HindIII")
    ...
    .. code::
        ...
        rp_generator = bloom.SamBamReadPairGenerator("output/sam/SRR4271982_chr18_19_1_sort.bam",
                                                    "output/sam/SRR4271982_chr18_19_2_sort.bam")
        rp.add_read_pairs(rp_generator, threads=4)


    You can query regions using the :class:`~bloom.RegionBased` interface:
    ...
    def pairs(self, key=None, lazy=False, *args, **kwargs):
        ...
        :param key: Region string of the form <chromosome>[:<start>-<end>],
                    :class:`~bloom.GenomicRegion` or tuples thereof
    ...
    def to_hic(self, file_name=None, tmpdir=None, _hic_class=Hic):
        """
        Convert this :class:`~ReadPairs` to a :class:`~bloom.Hic` object.

        :param file_name: Path to the :class:`~bloom.Hic` output file
...
class ReadFilter(object):
    ...
    def __init__(self, mask=None):
        ...
        :param mask: The :class:`~bloom.general.Mask` object that
