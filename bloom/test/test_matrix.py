...
from bloom.matrix import Edge, RegionPairsTable, RegionMatrixTable, RegionMatrix
from bloom.hic import Hic, _get_overlap_map, _edge_overlap_split_rao, kr_balancing, ice_balancing
from bloom.regions import Chromosome, Genome
from bloom.pairs import ReadPairs, SamBamReadPairGenerator
from bloom.tools.matrix import is_symmetric
from bloom.compatibility.juicer import JuicerHic
from bloom.compatibility.cooler import CoolerHic
from bloom.tools.load import load
import tables
import pytest
...
class TestHic(RegionMatrixContainerTestFactory):
    def setup_method(self, method):
        hic_file = os.path.join(test_dir, 'test_matrix', 'test_bloom.hic')
