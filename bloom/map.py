...
mapping capabilities of bloom. Take a look at the code of :class:`~Bowtie2Mapper` for
an example.
...
.. code::
    ...
    import bloom
    mapper = bloom.BwaMapper("bwa-index/hg19_chr18_19.fa", min_quality=3)
    bloom.iterative_mapping("SRR4271982_chr18_19_1.fastq.gzip", "SRR4271982_chr18_19_1.bam",
