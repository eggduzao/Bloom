...
import tables as t
from bloom.legacy.data.genomic import AccessOptimisedRegionMatrixTable, Edge, LazyEdge
from bloom.legacy.data.general import MaskFilter
import msgpack
import msgpack_numpy
import math
import pandas as pd
from bloom.tools.general import RareUpdateProgressBar, pairwise
import warnings
...
class ObservedPeakFilter(PeakFilter):
    ...
    def __init__(self, cutoff=1, mask=None):
        ...
        :param mask: A :class:`~bloom.data.general.Mask` object.
    ...
    def valid_peak(self, peak):
        ...
        :param peak: An :class:`~bloom.data.genomic.Edge` object
...
class RaoPeakCaller(PeakCaller):
    ...
    def call_peaks(self, hic, chromosome_pairs=None, file_name=None, intra_expected=None, inter_expected=None):
        ...
        :param hic: A :class:`~bloom.data.genomic.Hic` object
...
def overlap_peaks(peaks, max_distance=6000):
    ...
    :return: DataFrame of overlap statistics and dictionary
             ...
             of dataset names.
    :rtype: (pandas.DataFrame, bloom.data.network.PeakInfo)
    """
