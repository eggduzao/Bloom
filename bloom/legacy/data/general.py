...
from bloom.tools.files import create_or_open_pytables_file, tmp_file_name
from bloom.tools.general import RareUpdateProgressBar, create_col_index
import os
    ...
    def __init__(self, file_name=None, mode='a', tmpdir=None,
        ...
        if hasattr(self, 'file'):
            ...
            if tmpdir is None or (isinstance(tmpdir, bool) and not tmpdir):
                ...
                self.tmp_file_name = tmp_file_name(tmpdir, prefix='tmp_bloom', extension='h5')
