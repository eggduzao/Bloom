...
from bloom.architecture.architecture import calculateondemand
from bloom.architecture.genome_architecture import MatrixArchitecturalRegionFeature, VectorArchitecturalRegionFeature
from bloom.data.genomic import GenomicRegion, Node, Edge
import tables as t
import types
import numpy as np
