...
import bloom
import bloom.plotting as kplot
import os.path
import pytest
import numpy as np
...
class TestHicPlot:
    def setup_method(self, method):
        self.hic = bloom.load(bloom.example_data["hic"], mode="r")
...
class TestPlots:
    def setup_method(self, method):
        self.bigwig_path = bloom.example_data["chip_bigwig"]
        self.pyBigWig = pytest.importorskip("pyBigWig")
        self.bigwig = self.pyBigWig.open(bloom.example_data["chip_bigwig"])
        self.bedgraph_path = bloom.example_data["chip_bedgraph"]
        self.gtf_path = bloom.example_data["gene_gtf"]
        self.peak_path = bloom.example_data["chip_peak_bed"]
