...
def run_bloomplot(*args):
    args = ["bloomplot"] + [str(x) for x in args]
...
@pytest.mark.bloomplot
class TestHicPlot:
    def setup_method(self, method):
        self.hic_path = bloom.example_data["hic"]
...
class TestScorePlots:
    def setup_method(self, method):
        self.bigwig_path = self.bigwig_path = bloom.example_data["chip_bigwig"]
