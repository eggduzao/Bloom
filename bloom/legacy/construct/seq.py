...
.. code:: python
    ...
    # load genome object
    genome = bloom.data.genomic.Genome.from_folder("/path/to/fasta_folder/")
...
from bloom.tools.general import RareUpdateProgressBar, add_dict, find_alignment_match_positions, WorkerMonitor
from bloom.tools.sambam import natural_cmp
from bloom.tools.files import is_sambam_file, create_temporary_copy
from bloom.legacy.data.general import Maskable, MaskFilter, MaskedTable, FileBased, Mask
import os
from tables.exceptions import NoSuchNodeError
from abc import abstractmethod, ABCMeta
from bisect import bisect_right
from bloom.tools.general import bit_flags_from_int, CachedIterator
from bloom.legacy.data.genomic import RegionsTable, GenomicRegion, AccessOptimisedRegionPairs, Edge, AccessOptimisedHic, Hic
...
class FragmentMappedReadPairs(Maskable, RegionsTable, FileBased):
    ...
    :class:`~bloom.data.genomic.Genome` object), and filter the list of pairs by
    different criteria.
    ...
    def load(self, reads1, reads2, regions=None, ignore_duplicates=True, _in_memory_index=True, excluded_filters=()):
        ...
        :param regions: A list of genomic regions that will be used to assign
                        reads. Look at :class:`~bloom.data.genomic.RegionsTable`
...
class FragmentRead(object):
    ...
    .. attribute:: fragment
        ...
        A :class:`~bloom.data.genomic.GenomicRegion` delineated by
        restriction sites.
    ...
    def __init__(self, fragment=None, position=None, strand=0, qname_ix=None):
        ...
        :param fragment: A :class:`~bloom.data.genomic.GenomicRegion` delineated by
                         restriction sites.
