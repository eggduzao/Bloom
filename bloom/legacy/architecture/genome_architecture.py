...
from bloom.regions import RegionsTable, GenomicRegion
from bloom.matrix import RegionMatrixTable
from bloom.legacy.architecture.architecture import ArchitecturalFeature, calculateondemand, \
    _get_pytables_data_type
from bloom.general import MaskFilter
...
class VectorArchitecturalRegionFeature(RegionsTable, ArchitecturalFeature):
    ...
    def __init__(self, file_name=None, mode='a', data_fields=None,
        ...
        :param regions: Any iterable with objects accepted by
                        :func:`~bloom.data.genomic.GenomicRegions.add_region`.
...
class GenomicTrack(BasicRegionTable):
    ...
    def __init__(self, file_name=None, title=None, data_dict=None, regions=None, _table_name_tracks='tracks',
        ...
        :param regions: An iterable of (:class: `~bloom.data.genomic.GenomicRegion`)
