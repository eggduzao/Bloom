...
def load(file_name, *args, **kwargs):
    ...
    objects generated by bloom (:class:`~Hic`, :class:`~ReadPairs`,
    ...
    - :class:`~RegionBased` for genomic region formats (BED, GFF, ..., but
      also most bloom objects)
    - :class:`~RegionMatrixContainer` or :class:`~RegionPairsContainer` for
      read pair or matrix-based bloom objects, as well as Cooler and Juicer
      files
    ...
    try:
        with warnings.catch_warnings():
            ...
            from bloom.compatibility.cooler import is_cooler, CoolerHic
    ...
    from bloom.compatibility.juicer import JuicerHic, is_juicer
