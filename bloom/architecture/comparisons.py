...
class ComparisonMatrix(RegionMatrixTable):
    ...
    def from_matrices(cls, matrix1, matrix2, file_name=None, tmpdir=None, mode='w',
        ...
        bloom, offering the same convenience functions for regions and
        edges.
        ...
        :param kwargs: Keyword arguments passed to
                       :func:`~bloom.matrix.RegionPairsContainer.edges`
        :return: :class:`~bloom.architecture.comparisons.ComparisonMatrix`
        """
        kwargs['lazy'] = True
...
class ComparisonScores(RegionScoreParameterTable):
    ...
    def from_scores(cls, scores1, scores2, attributes=None, file_name=None, tmpdir=None,
        ...
        """
        Compare parameter-based scores in a :class:`~bloom.architecture.domains.RegionScoreParameterTable`.

        :param scores1: First :class:`~bloom.architecture.domains.RegionScoreParameterTable`
        :param scores2: Second :class:`~bloom.architecture.domains.RegionScoreParameterTable`
        ...
        :return: :class:`~bloom.architecture.comparisons.ComparisonScores`
        """
...
class ComparisonRegions(RegionsTable):
    ...
    def from_regions(cls, region_based1, region_based2, attribute='score',
        ...
        :param kwargs: Keyword arguments passed on to :func:`~genomic_regions.RegionBased.regions`
        :return: :class:`~bloom.architecture.comparisons.ComparisonRegions`
        """
...
class SplitMatrix(object):
    ...
    def matrix(self, *args, **kwargs):
        ...
        :param kwargs: Keyword arguments passed to both matrices
                       :func:`~bloom.matrix.RegionMatrixContainer.matrix`
                       functions.
...
def hic_pca(*hics, sample_size=None, region=None, strategy='variance', scale=True, log=False,
    ...
    :param kwargs: Keyword arguments passed to :func:`~bloom.matrix.RegionMatrixTable.edges`
