...
.. code::
    ...
    bloom pca -n "HindIII 100k" "HindIII 5M" "MboI 100k" "MboI 1M" "MboI 50k" \
...
``bloom pca`` to use only non-zero matrix entries for the PCA - this can help mitigate
...
Finally, ``bloom pca`` offers two filters designed to remove uninformative contacts
