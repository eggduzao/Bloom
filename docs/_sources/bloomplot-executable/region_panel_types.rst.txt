...
.. image:: images/bloomplot_line.png
...
.. image:: images/bloomplot_line_step.png
...
.. image:: images/bloomplot_line_fill.png
...
.. image:: images/bloomplot_line_limit.png
...
.. image:: images/bloomplot_line_color.png
...
.. image:: images/bloomplot_line_multi.png

You can label datasets with ``-l``, which will add a legend to your plot. By default,
bloom will try to find a placement with minimum overlap to the plotted lines. If you prefer,
...
.. image:: images/bloomplot_line_labels.png
...
.. image:: images/bloomplot_line_legend.png
...
parameter choice. It currently supports the :class:`~bloom.architecture.domains.InsulationScores`
and :class:`~bloom.architecture.domains.DirectionalityIndexes` objects, but can in
...
.. image:: images/bloomplot_scores_example.png
...
.. image:: images/bloomplot_scores_genomic.png
...
.. image:: images/bloomplot_scores_parameters.png
...
.. image:: images/bloomplot_bar_example.png
...
showing all possible domain boundaries called from the insulation score (``bloom boundaries``).
...
.. image:: images/bloomplot_bar_boundaries.png
...
.. image:: images/bloomplot_bar_combined.png
...
.. image:: images/bloomplot_layer.png
...
.. image:: images/bloomplot_layer_bed.png
...
individual features. For that purpose, ``bloomplot`` proves the ``gene`` panel. It is intended for use
