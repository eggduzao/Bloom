...
Also have a look at the command line documentation at :ref:`bloom-aggregate`, which explains
...
bloom distinguished three kinds of aggregate analyses:
...
All of these can be computed using the :class:`~bloom.architecture.aggregate.AggregateMatrix`
...
:func:`~bloom.architecture.aggregate.AggregateMatrix.from_center` like this:
...
You can plot the aggregate matrix using the covenience function :func:`~bloom.plotting.aggregate_plot`:
...
too much, particular for a chromosome-based normalisation strategy, as is the default in bloom.
...
We can visualise the region using :func:`~bloom.plotting.aggregate_plot`
...
:func:`~bloom.architecture.aggregate.AggregateMatrix.from_region_pairs` allows us to aggregate
...
it as a ``numpy`` array via :func:`~~bloom.architecture.aggregate.AggregateMatrix.matrix`:
...
:func:`~~bloom.architecture.aggregate.AggregateMatrix.components`:
