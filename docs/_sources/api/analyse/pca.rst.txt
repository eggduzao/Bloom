...
PCA is one way in bloom to compare different Hi-C matrices to each other. A matrix of
...
In bloom, simply use :func:`~bloom.architecture.comparisons.hic_pca` for this purpose,
...
We can plot the result using :func:`~bloom.plotting.pca_plot`:
...
For more options have a look at the API reference for :func:`~bloom.plotting.pca_plot`.
