...
After importing ``bloom.plotting`` as ``bloomplot``, we have access to a range of Hi-C (and related)
matrix plots. We already used the :class:`~bloom.plotting.hic_plotter.TriangularHicPlot` as an example in
:ref:`api_plot_basics`. In total there are four types of matrix visualisation built in to bloom:

- :class:`~bloom.plotting.hic_plotter.SquareHicPlot`, which shows a square matrix, with colors typically
  representing contact strength between the two genomic regions on the X, and Y axes, respectively.
- :class:`~bloom.plotting.hic_plotter.TriangularHicPlot`, which rotates the matrix by 45 degrees, so
...
- :class:`~bloom.plotting.hic_plotter.SplitMatrixPlot`, which is similar to the
  :class:`~bloom.plotting.hic_plotter.SquareHicPlot`, but the values above and below the diagonal
  are from different matrices. This is a great way for direct matrix feature comparisons in the same
  plot.
- :class:`~bloom.plotting.plotter.MirrorMatrixPlot`, which can be used to show two matrix plots,
  particularly of the type :class:`~bloom.plotting.hic_plotter.TriangularHicPlot`, mirrored at the
  X axis


All of these are built on the base class :class:`~:bloom.plotting.base_plotter.BasePlotterMatrix`, so
...
.. literalinclude:: code/matrix_plot_examples.py
    :language: python
    :start-after: start snippet bloomplot square string
    :end-before: end snippet bloomplot square string
...
.. literalinclude:: code/matrix_plot_examples.py
    :language: python
    :start-after: start snippet bloomplot square vmax
    :end-before: end snippet bloomplot square vmax

.. image:: images/plot_square_vmax.png

bloom uses the custom "germany" colormap as a default, built using the
...
.. literalinclude:: code/matrix_plot_examples.py
    :language: python
    :start-after: start snippet bloomplot square cmap
    :end-before: end snippet bloomplot square cmap
...
.. literalinclude:: code/matrix_plot_examples.py
    :language: python
    :start-after: start snippet bloomplot square log
    :end-before: end snippet bloomplot square log
...
.. literalinclude:: code/matrix_plot_examples.py
    :language: python
    :start-after: start snippet bloomplot square uncorrected
    :end-before: end snippet bloomplot square uncorrected
...
.. literalinclude:: code/matrix_plot_examples.py
    :language: python
    :start-after: start snippet bloomplot square oe
    :end-before: end snippet bloomplot square oe
...
:class:`~bloom.plotting.hic_plotter.TriangularHicPlot`.

.. literalinclude:: code/matrix_plot_examples.py
    :language: python
    :start-after: start snippet bloomplot triangular string
    :end-before: end snippet bloomplot triangular string
...
.. literalinclude:: code/matrix_plot_examples.py
    :language: python
    :start-after: start snippet bloomplot triangular maxdist
    :end-before: end snippet bloomplot triangular maxdist
...
The :class:`~bloom.plotting.hic_plotter.SplitMatrixPlot` requires two Hi-C objects, one for
...
To showcase the :class:`~bloom.plotting.plotter.MirrorMatrixPlot`, we can plot the Hi-C matrix,
and its O/E transformation at the same time:

.. literalinclude:: code/matrix_plot_examples.py
    :language: python
    :start-after: start snippet bloomplot mirror
    :end-before: end snippet bloomplot mirror
